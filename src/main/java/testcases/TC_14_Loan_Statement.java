...
public class TC_14_Loan_Statement  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC14-Loan Statement";
		testDescription="Checking the Loan Statement";
		browserName="Chrome";
...
.clickloan_link()
.clickloan_Statement_link()
.selectAccount(accnum)
.VerifyElementPresent(prop.getProperty("click.loanStatement.verify.xpath"), "Loan Statement has been dispalying","Loan Statement has not been dispalying");
