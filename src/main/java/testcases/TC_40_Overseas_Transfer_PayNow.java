...
public class TC_40_Overseas_Transfer_PayNow  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC40 Overseas_Transfer_PayNow";

		testDescription="Overseas_Transfer_PayNow";
		browserName="Chrome";
...
.clickPayment_link()
.clickvendor()
.Overseas_Transerpage("Today","Pay Now",fromcomp,tobene,fromaccnum,nickname,currency,
		amount,Purpose,frequency,timesofpay)
.fillOtp("OwnAccountOtpSubmit")
.verifysucessmsg()
.clickPayment_Report_link()
.OwnPaymentStatusCheck(prop.getProperty("overseas.acc.type.xpath"),"Pending Authorization","Pending Authorization","Today")
...
.OwnPaymentStatusCheck(prop.getProperty("overseas.acc.type.xpath"), "Success","Success","Today")
