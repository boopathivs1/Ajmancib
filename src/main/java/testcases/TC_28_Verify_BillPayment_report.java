...
public class TC_28_Verify_BillPayment_report  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC28_Verify_BillPayment_report";
		testDescription="Verify_BillPayment_report";
		browserName="Chrome";
