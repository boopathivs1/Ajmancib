...
public class TC_42_Overseas_Transfer_Repeat  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC42_Overseas_Transfer_Repeat";

		testDescription="Overseas_Transfer_Repeat";
		browserName="Chrome";
...
.clickPayment_link()
.clickvendor()
.Overseas_Transerpage("Tomorrow","Repeat",fromcomp,tobene,fromaccnum,nickname,currency,
