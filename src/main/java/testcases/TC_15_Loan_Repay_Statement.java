...
public class TC_15_Loan_Repay_Statement  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC15-Loan Repay Statement";
		testDescription="Checking the Loan Repay Statement";
		browserName="Chrome";
...
.clickloan_link()
.clickloan_Repay_link()
.selectAccount(accnum)
.verifyloanrepayLinks();
