...
public class TC_34_Within_Transfer_PayLater  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC34 Within_Transfer_PayLater";

		testDescription="Within_Transfer_PayLater";
		browserName="Chrome";
...
.clickPayment_link()
.clickvendor()
.within_Transerpage("Tomorrow","Pay Later",fromcomp,tobene,fromaccnum,nickname,currency,
