...
public class TC_35_Within_Transfer_Repeat  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC35 Within_Transfer_Repeat";

		testDescription="Within_Transfer_Repeat";
		browserName="Chrome";
...
.clickPayment_link()
.clickvendor()
.within_Transerpage("Tomorrow","Repeat",fromcomp,tobene,fromaccnum,nickname,currency,
