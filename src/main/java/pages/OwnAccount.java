...
public class OwnAccount  extends ProjectWrapp{
	...
	public OtP_Page ownTranserpage(String paydate,String payday,String fromcomp,String accno,String tocomp,String toAccno,String currency,String amount,String frequency,String timesofpay) throws InterruptedException{
		locateFrame("icanvas");
...
//Thread.sleep(3000);
dropdownSelection(prop.getProperty("owntransfer.fromaccount.xpath"),accno);
//Thread.sleep(10000);
